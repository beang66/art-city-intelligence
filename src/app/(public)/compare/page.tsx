...
export default function ComparePage() {
  const comparisons = ['seoul', 'berlin', 'milan'].map((slug) => {
    ...
    <>
      <section className="section page-hero compact-hero">
        ...
        <div className="surface hero-panel">
          ...
          <div className="comparison-orbit"><div className="orbit orbit-a" /><div className="orbit orbit-b" /><div className="orbit orbit-c" /><div className="orbit-core"><strong>SEOUL</strong><small>SELECTED CITY</small></div><span className="orbit-city city-a">BERLIN<b>−4.2</b></span><span className="orbit-city city-b">MILAN<b>+2.8</b></span><span className="orbit-city city-c">COHORT MEDIAN<b>68.1</b></span><span className="orbit-city city-d">GLOBAL BEST<b>91.4</b></span></div>
